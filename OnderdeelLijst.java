...
public class OnderdeelLijst extends Onderdeel {
    ...
    public static List<Onderdeel> createOnderdelen() {
        return List.of(
                new Onderdeel("HoutenRomp","klassiek, warm, en milieuvriendelijk.",Categorie.ESSENTIEEL,1,5000.00,"ROMP",0.80),
                new Onderdeel("AluminiumRomp","licht en sterk.",Categorie.ESSENTIEEL,1,7000.00,"ROMP",0.00),
                new Onderdeel("VezelglasRomp","licht, sterk, en flexibel.",Categorie.ESSENTIEEL,1,10000.00,"ROMP",0.00),
                new Onderdeel("StalenRomp","sterk, robuust, en duurzaam.",Categorie.ESSENTIEEL,1,29500.00,"ROMP",0.00),
                new Onderdeel("900PK Motor","krachtig, duur, en high-end.",Categorie.ESSENTIEEL,1,80000.00,"ENGINE",0.00),
                new Onderdeel("300PK Motor","gemiddeld, betaalbaar, en betrouwbaar.",Categorie.ESSENTIEEL,1,40000.00,"ENGINE",0.80),
                new Onderdeel("Mechanische Roer","Een mechanische roer met kabel",Categorie.ESSENTIEEL,1,2000.00,"ROER",0.80),
                new Onderdeel("Tandheugel Roer","precies, betrouwbaar, en wendbaar.",Categorie.ESSENTIEEL,1,1000.00,"ROER",0.00),
                new Onderdeel("Basis hoofdstroomsyteem","eenvoudig, minimale functies.",Categorie.ESSENTIEEL,1,700.00,"ELEKSYS",0.00),
                new Onderdeel("Gemiddeld hoofdstroomsyteem","hogere capaciteit, extra functies.",Categorie.ESSENTIEEL,1,1500.00,"ELEKSYS",0.00),
                new Onderdeel("Geavanceerd hoofdstroomsyteem"," geïntegreerde monitoring, controle.",Categorie.ESSENTIEEL,1,4000.00,"ELEKSYS",0.80),
                ...
                new Onderdeel("Basis interieur installatie","eenvoudig en functioneel.",Categorie.EXTRA,1,3000.00,"INTERIEUR",0.00),
                new Onderdeel("Gemiddelde interieur installatie","meer comfort en kwaliteit.",Categorie.EXTRA,1,10000.00,"INTERIEUR",0.00),
                ...
                new Onderdeel("Plow anker","allround, effectief.",Categorie.EXTRA,1,250.00,"ANKER",0.00),
                ...
                new Onderdeel("Satelliettelefoon","wereldwijde dekking, duur.",Categorie.EXTRA,1,1000.00,"COMMUNICATIE",0.00),
                new Onderdeel("Satellietcommunicatie","geavanceerd, realtime.",Categorie.EXTRA,1,10000.00,"COMMUNICATIE",0.00)
